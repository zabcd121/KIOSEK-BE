...
<div>
<hr>
<h2 align="center">✅ 시스템 목적</h2>
<p align="center">주 목적은 프로젝트실을 예약하고 사용하는데 있어서 편의성을 제공하고자 한다.</p>
<p align="center">본 시스템이 부재했던 때에 여러 불편함을 해소하고 사용자 추척이 불가능하여 미흡한 책임감으로 인하여 유지되지 못한 좌석 청결 문제를 해결한다. </p>
<p align="center">결국 사용자에게 편의성을 제공하지만 책임감을 부여하여 매너있는 태도로 공공시설을 사용하도록 한다.</p>
<hr>
<h2 align="center">📱 시스템 주요 Flow</h2>
<p align="center"><em>사용자는 https://kiosek.kr 브라우저를 통해 예약하거나 현장에서 키오스크를 통해 현장예약하여 바로 사용할 수 있다.</em></p>
<p align="center" style="font-size: 17px"><b>1. 웹을 통해 실시간으로 프로젝트실 예약 상황을 확인할 수 있고 원하는 시간에 테이블을 예약하면 예약당 QR코드가 발급된다.</b></p>
<p align="center">(사용자당 하루에 1번 최대 4시간 2주뒤까지에 대해서 예약 가능하다.)</p>
<p align="center" style="font-size: 17px"><b>2. 발급된 예약확인 QR코드를 키오스크에 인식하여 체크인 한다.</b></p>
<p align="center">(체크인 가능 시간은 예약 시작시간 20 분전부터 예약 시작시간 20분 후까지이며 해당 시간내로 QR체크인을 진행하지 않을 경우 <b>미사용</b>으로 간주되어 위반내역에 기록되며 즉시 예약이 취소된다.)</p>
<p align="center" style="font-size: 17px"><b>3. 사용후에는 웹을 통해 좌석사진과 함께 반납한다.</b></p>
<p align="center" style="font-size: 17px"><b>4. 사용종료시간 20분 후까지 좌석사진과 함께 반납처리하지 않을 경우 <b>미반납</b>으로 간주되어 위반내역에 기록된다.</b></p>
<p align="center" style="font-size: 17px"><b>5. 위반내역이 <b>3회</b> 발생할 경우 <b>3일간</b> 예약이 불가능하다.</b></p>
<br></br>
<hr>
<h2 align="center">👨🏼‍🔧 프로젝트실 관리자 주요 기능</h2>
<p align="center" style="font-size: 17px">1. 전체적인 예약 상황 모니터링</p>
<p align="center" style="font-size: 17px">2. 특식배부와 같은 이유로 테이블을 사용하지 못하도록 해야하는경우 해당 테이블을 특정 기간동안 비활성화</p>
<p align="center" style="font-size: 17px">3. 위반내역 및 제재내역을 확인 및 정지 해제</p>
<p align="center" style="font-size: 17px">4. 예약 정책과 제재 정책을 수정</p>
<p align="center" style="font-size: 17px">5. 사용자의 민원 확인</p>
</div>
<br>
<hr>
...
<h3>3. 마이페이지</h3>
    <h3>(1) 예약 내역 조회</h3>
    <img src="https://user-images.githubusercontent.com/68465716/237259301-a39c3739-de01-4c99-825a-c3af3b892e06.png" width="1000" height="700">
    <h3>(2) 과거 예약 내역 조회</h3>
    <img src="https://user-images.githubusercontent.com/68465716/237260124-f66b6f43-ecaf-4d4e-9f4c-17f3379f7bba.png" width="1000" height="700">
    <h3>(3) 위반 내역 조회</h3>
    <img src="https://user-images.githubusercontent.com/68465716/237260549-8dae6e02-52b6-487b-8dbf-e501dafac912.png" width="1000" height="650">
    <h3>(4) 반납</h3>
    <p>체크인 후 반납하기 버튼 활성화됨</p>
    <img src="https://user-images.githubusercontent.com/68465716/237260541-af0b9074-0a8f-4f29-99d9-05960395e2c5.png" width="1000" height="650">
    ...
    <img src="https://user-images.githubusercontent.com/68465716/237259305-9263d255-b49c-404c-8202-0b941fb2b400.png" width="1000" height="650">
