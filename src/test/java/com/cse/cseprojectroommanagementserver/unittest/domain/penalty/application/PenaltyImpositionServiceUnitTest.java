package com.cse.cseprojectroommanagementserver.unittest.domain.penalty.application;
...
class PenaltyImpositionServiceUnitTest {
    ...
    @InjectMocks
    PenaltyImpositionService penaltyImpositionService;
    ...
    void 제재_성공_기존에제재중인회원_새로운종료일이기존보다과거인경우() {
        ...
        // When, Then
        Assertions.assertThrows(BusinessRuleException.class, () -> penaltyImpositionService.imposePenalty(penaltyImpositionReq));
    }
}