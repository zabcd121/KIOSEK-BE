package com.cse.cseprojectroommanagementserver.unittest.domain.penaltypolicy.application;
...
class PenaltyPolicyChangeServiceUnitTest {
    ...
    void 제재정책변경_실패_해당정책존재X() {
        ...
        // When, Then
        assertThrows(NotFoundException.class, () -> penaltyPolicyChangeService.changePenaltyPolicy(changeReq));
    }
}