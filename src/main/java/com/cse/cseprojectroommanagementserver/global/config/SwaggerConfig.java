...
public class SwaggerConfig {  // Swagger
    ...
    private static final String API_NAME = "컴퓨터소프트웨어공학과 프로젝트실 예약 및 운영 API";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cse.cseprojectroommanagementserver.domain"))  // Swagger를 적용할 클래스의 package명
